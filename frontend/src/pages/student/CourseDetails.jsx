...
const CourseDetails = () => {
    ...
    const { navigate, allCourses, calculateRating, calculateChapterTime, calculateCourseDuration, calculateNoOfLectures, currency } = useContext(AppContext);
    ...
    return courseData ? (
        <>
            <div className='relative flex md:flex-row flex-col-reverse gap-10 items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
                ...
                {/*  Gradient Background */}
                <div className='absolute top-0 left-0 w-full h-full z-[-1] bg-gradient-to-b from-cyan-100 via-white to-blue-50'></div>
                ...
                <div className='max-w-xl z-10 text-gray-500'>
                    ...
                    <p className='text-sm'>
                        Course by <span className='text-blue-600 underline'>Deepak Singh</span>
                    </p>
                ...
                {/*  Right Column (Add your course thumbnail, video, or content here) */}
                <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
                    {/* Example placeholder */}
                    {
                        playerData ?
                            ...
                            : <img
                                src={courseData.courseThumbnail || assets.defaultCourseThumbnail}
                    ...
                    <div className='p-5'>
                        ...
                        <button onClick={() => navigate("/my-enrollments")} className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium cursor-pointer'>{isAlreadyEnrolled ? 'Already Enrooled' : 'Enroll Now'}</button>
                        <div className='pt-6'>
